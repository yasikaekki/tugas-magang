        ...
        <div class="container-fluid">
          ...
          <div class="row my-4">
              <div class="col-md-12">
                  <div class="card p-4">
                    <div class="card-body">
                        <h3 class="mb-5">Ubah akun perusahaan</h2>
                        <form action="{{route('data_perusahaan.update', $user->id)}}" method="post" enctype="multipart/form-data">
                            @method('PATCH')
                            @csrf
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <label>Nama</label>
                                            <input name="nama_perusahaan" type="text" class="mb-3 form-control @error('name') is-invalid @enderror" id="exampleInputName1" aria-describedby="nameHelp" placeholder="Nama" value="{{$user->name}}">
                                        ...
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input name="email_perusahaan" type="email" placeholder="Email" class="mb-3 form-control @error('nama_perushaan') is-invalid @enderror" value="{{$user->email}}">
