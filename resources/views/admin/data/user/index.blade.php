              ...
              <div class="card p-4 mt-5">
                  <div class="card-body">
                      ...
                      <div class="d-grid col-3 mx-auto">
                          <a class="btn btn-primary" href="{{route('data_user.create')}}"><i class="bi bi-person-plus-fill"></i> Klik di sini</a>
                      </div>
                  </div>
              </div>
            </div>
            ...
            <div class="col-md-12">
              ...
              <div class="card p-4">
                <!-- <div class="d-flex justify-content-end">
                  <a href="{{route('data_user.create')}}" class="btn btn-success mb-3"><i class="bi bi-plus-square-fill"></i> Tambah</a>
                </div> -->
                ...
                <table class="table table-bordered" id="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center text-danger">Belum verifikasi</td>
                        @else
                        ...
                        <td>
                            <div class="d-flex justify-content-evenly">
                                <a href="{{route('data_user.edit', $users->id)}}" class="btn btn-primary px-4">Edit</a>
                                        ...
                                        <div class="modal-content">
                                            <div class="p-3">
                                                ...
                                                <div class="d-flex justify-content-evenly p-3">
                                                    ...
                                                    <form action="{{route('data_user.destroy', $users->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
...
<script>
  ...
  // function mencari(value){
  //   Object.assign(query, {'hasil_cari' : $('#keywoard').val()});

  //   window.location.href = "{{route('data_user.index')}}?"+$.param(query);
  // }
