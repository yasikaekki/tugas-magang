              ...
              <div class="card p-4">
                ...
                <div class="d-flex justify-content-between">
                  <div class="col-md-5 p-0">
                    <a href="{{route('data_admin.create')}}" class="btn btn-success mb-3"><i class="bi bi-plus-square-fill"></i> Tambah</a>
                  </div>
                  <div class="col-md-2">
                  </div>
                  <div class="col-md-5 p-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            @else
                            <span class="badge bg-warning">{{$users->role}}</span>
                            @endif
                        </td>
                        <td>
                            @if($users->role == 'super admin')
                            <div class="d-grid mx-4 gap-2">
                              <a href="{{route('data_admin.edit', $users->id)}}" class="btn btn-primary">Edit</a>
                            </div>
                            @else
                            <div class="d-flex justify-content-evenly">
                              <a href="{{route('data_admin.edit', $users->id)}}" class="btn btn-primary px-4">Edit</a>
                                  ...
                                  <div class="modal-content">
                                    <div class="p-3">
                                      ...
                                      <div class="d-flex justify-content-evenly p-3">
                                        ...
                                        <form action="{{route('data_admin.destroy', $users->id)}}" method="post">
                                          @csrf
                                          @method('DELETE')
...
<script>
  ...
  function sort(value){
    ...
    window.location.href = "{{route('data_admin.index')}}?"+$.param(query);
  }
