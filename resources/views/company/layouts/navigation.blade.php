@if($judul == 'Situs Penyedia Jasa Informasi Magang Terpercaya dan Terlengkap di Kabupaten Banyuwangi'  || $judul == 'Notifikasi' || $judul == 'Status Lowongan' || $judul == 'Status Pelamar')
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top shadow">
    <div class="container-fluid mx-4">
        ...
        <form action="/home" method="GET" class="d-flex align-items-center col-md-7 px-0">
        ...
        <form action="{{route('notifikasi.index')}}" method="GET" class="d-flex align-items-center col-md-7 px-0">
            <input class="form-control me-2" name="hasil_cari" type="search" placeholder="{{$mencari}}" aria-label="Search">
            <button class="btn bg-light" type="submit"><i class="bi bi-search"></i></button>
        </form>
        @elseif($judul == 'Status Lowongan')
        <form action="{{route('lamaran.index')}}" method="GET" class="d-flex align-items-center col-md-7 px-0">
            <input class="form-control me-2" name="hasil_cari" type="search" placeholder="{{$mencari}}" aria-label="Search">
            <button class="btn bg-light" type="submit"><i class="bi bi-search"></i></button>
        </form>
        @elseif($judul == 'Status Pelamar')
        <form action="{{route('lamaran.show', $postingan)}}" method="GET" class="d-flex align-items-center col-md-7 px-0">
            <input class="form-control me-2" name="hasil_cari" type="search" placeholder="{{$mencari}}" aria-label="Search">
            <button class="btn bg-light" type="submit"><i class="bi bi-search"></i></button>
        </form>
        @endif
        ...
        <div class="form-group mx-4">
            <a href="{{route('lowongan.create')}}" class="btn btn-light"><i class="bi bi-plus-square-fill"></i><strong> Buat Lowongan</strong></a>
        </div>
        ...
        <div class="collapse navbar-collapse flexcolum flexwrapp aligncontentend" id="navbarSupportedContent">
            <ul class="navbar-nav align-items-center">
                <div class="btn-group">
                    ...
                    <ul class="collapse dropdown-menu dropdown-menu-end overflow-auto scrolll">
                        ...
                        @if(count($notifikasi) > 0)
                            ...
                            <li><p class="dropdown-item d-flex justify-content-center small"><a href="{{route('notifikasi.index')}}" class="text-decoration-none">semua notifikasi</a></p></li>
                        @else
                ...
                <div class="btn-group">
                    ...
                    @if($userid->perusahaan->ubah_foto == null)
                    ...
                    @else
                    <button class="bg-transparent border-0 text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="/imagesPerusahaan/{{$userid->perusahaan->ubah_foto}}" class="rounded-circle border border-2" style="width: 40px; height:40px;" alt="" srcset="">
                    </button>
                    @endif
            ...
            <ul class="navbar-nav align-items-center">
                ...
                <div class="btn-group">
                    ...
                    <button class="bg-transparent border-0 text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <img src="{{asset('imagesPerusahaan/'. $userid->perusahaan->ubah_foto)}}" class="rounded-circle border border-2" style="width: 40px; height:40px;" alt="" srcset="">
                    </button>
                    @endif
